/* ==========================================================================
   WEATHER DASHBOARD API CLIENT (api.js)
   ========================================================================== */

import { getWeatherDescByWmoCode } from "./icons.js";
...
// WMO weather code mapping to simple short name for forecast display
function getForecastDayIcon(code) {
